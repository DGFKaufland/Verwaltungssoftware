...
public class Sensors_Controller
{
   ...
   // private DBStatements_Departures dbs_departures = new DBStatements_Departures();
    ...
    {    	
    	...
    	System.out.println("departureName: " + departure_name);
    	System.out.println("CountryCode: " + country_code);
    	System.out.println("Store number: " + store_number);
    	...
    	logical_sensor_id = country_code + "_" + store_number + "_" + departure_name + "_" + output;
    ...
    @Consumes( {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    @Produces( {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void createSensor (Sensors sen)
    {
    ...
    @Consumes( {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    @Produces( {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void editSensor (final Sensors sen)
    {
    ...
    @Consumes( {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    @Produces( {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML } )
    public void deleteSensor (final Sensors sen)
    {
    ...
    public void editFileForSensor (Sensors sen)
    {
    ...
    public void deleteFileForSensor (Sensors sen)
    {
