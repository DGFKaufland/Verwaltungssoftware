	 ...
	 $('#btnWriteUserInDB').unbind('click').click(function() {
		 writeStoreInDB();
  	   	 ...
  	   	 function writeStoreInDB() {
  	   		 ...
  	   		 var mobile_user_role = $( "#selectMobileUserRole option:selected").text();
  	   	 ...
  	   	 $.ajax({
  	   	   	 ...
  	   	   	 data: JSON.stringify({
  	   	   		 ...
  	   	   		 "phone": phone,
  	   	   		 "role": role,
  	   	   		 "mobile_user_role": mobile_user_role
  		 		}),
...
function editUser(){
    	 ...
    	 $.ajax({
           	 ...
           	 success: function(data){
           		...
           		var Role = data.role;
           		var MobileUserRole = data.mobile_user_role;
           		var MobileContactID = data.mobile_contact_id;
            	...
            	localStorage.setItem("editMobileUserRole", MobileUserRole);
            	localStorage.setItem("editMobileContactID", MobileContactID);
	...
	function editUserInDB(){
			 ...
			 var salutation = $( "#editSelectAnrede option:selected").text();
	   		 ...
	   		 var mobile_user_role = $( "#editSelectMobileUserRole option:selected").text();
	   		 var mobile_contact_id = document.getElementById("editMobileContactId").value;
 	 ...
 	 $.ajax({
        	 ...
        	 success: function(data){
        		...
        		localStorage.removeItem("editCountryID");
             	...
             	localStorage.removeItem("editMobileUserRole");
             	localStorage.removeItem("editMobileContactID");
